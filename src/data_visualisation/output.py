...
def evaluate(y_true: list, y_pred: list, label_encoder: LabelEncoder, dataset: str, classification_type: str):
    """
    Evaluate classification model performance with accuracy, confusion matrix, ROC curve and compare with other papers' results.
    :param y_true: Ground truth of the data in one-hot-encoding type.
    :param y_pred: Prediction result of the data in one-hot-encoding type.
...
def compute_iou(y_pred, y_true):
    """
    Function for generating mean IOU of predicted masks
    """
...
def single_dice_coef(true, pred):
    """
    Function for generating dice coefficient of predicted masks
    """
...
def convert_paths_to_arrays(y, if_reshape=True, is_mask=False):
    """
    Function to convert image paths to array of pixel values 
    """
    y_arr = []
    for image in y:
        ...
        # If we want to plot and display preprocessed images
