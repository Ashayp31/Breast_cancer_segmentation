"""
Functions for creating UNet with ResNet backbone models as given in keras model for Resnet models from Github:
...
def ResNet(stack_fn,
    ...
    if config.pretrained == "none":
        ...
        x = layers.ZeroPadding2D(padding=((3, 3), (3, 3)), name='conv1_pad')(img_concat)
    ...
    forward_2, forward_3, forward_4, forward_5, x = stack_fn(x)
    ...
    return img_input, [forward_1, forward_2, forward_3, forward_4, forward_5]
...
def ResNet50Ext(include_top=False,
             weights="none",
             input_tensor=None,
             input_shape=None,
             pooling=None,
